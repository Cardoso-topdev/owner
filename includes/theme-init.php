...
register_nav_menus( array(
	...
	'landingmenu' => __( 'Landing Header Navigation', 'am' ),
	'landingnewmenu' => __( 'New Landing Header Navigation', 'am' ),
	'landingfooterleftmenu' => __( 'Landing Footer Left Navigation', 'am' ),
	'landingfooterrightmenu' => __( 'Landing Footer Right Navigation', 'am' ),
) );
