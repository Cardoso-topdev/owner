<?php
/*
Template Name: Content Modules Landing New
Template Post Type: page, post
*/

?>
<?php get_header( 'new-landing' ); ?>
	<main class="main">
		<?php if ( have_rows('content_modules') ) : ?>
            ...
            <?php while ( have_rows('content_modules') ) : the_row(); ?>
                ...
                <?php if ( get_row_layout() == 'header' ) : ?>
                    <!-- header -->
                    <section id="s-<?php echo $gg; ?>" class="section-intro py-9 mb-16 py-md-3 mb-md-0 mb-lg-0">
                        <div class="container">
                ...
                <?php elseif ( get_row_layout() == 'video_content' ) : ?>
	                <!-- video_content -->
	                <section id="s-<?php echo $gg; ?>" class="section-intro pt-9 py-md-3 mb-md-0 mb-lg-0">
						<div class="container">
							<div class="grid grid-intro">
								<div class="col-5 col-md-12 pb-md-4">
									<div class="head head-lg">
										<?php if( $heading = get_sub_field( 'heading' )): ?> 
                                            <h1>
                                                <?php echo $heading; ?>
                                            </h1>
									...
									<?php get_template_part_args( 'templates/landing-content-modules-cta-button', array( 'v' => 'cta_button', 'c' => 'btn btn-gradient get-a-free-demo', 'w' => 'p' ) ); ?>
								</div>
								<div class="col-7 col-md-12">
									<div class="img-intro-v2">
										<div class="animation-slider">
											<?php if( get_sub_field( 'video_slider' ) ): ?>
												<?php while( has_sub_field( 'video_slider' ) ): ?>
													<?php if( $video_url = get_sub_field( 'video_url' )): ?> 
														<?php $image = get_sub_field( 'video_poster' ) ?>
														<?php if( !empty( $image ) ): ?>
															<div class="animation-item">
																<div class="s-item">
																	<div class="video-block">
																		<!-- <img src="<?php echo $image['sizes']['']; ?>" alt="<?php echo $image['alt']; ?>" title="<?php echo $image['title']; ?>" /> -->
																		<span class="bg-stretch" style="background-image: url(<?php echo $image['url']; ?>)">
																		</span>
																		<a class="btn-play btn-play-lg" data-fancybox="" data-type=""
										...
										<div class="decor decor-t">
											<img alt="" title="slide-decor-t"
												data-src="https://owner.com/wp-content/uploads/2021/07/slide-decor-t.svg" class="lazyload"
												src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" />
											<noscript>
												<img src="https://owner.com/wp-content/uploads/2021/07/slide-decor-t.svg" alt=""
													title="slide-decor-t" />
											</noscript>
										</div>
										<div class="decor decor-b">
											<img alt="" title="slide-decor-b"
												data-src="https://owner.com/wp-content/uploads/2021/07/slide-decor-b.svg" class="lazyload"
												src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" />
											<noscript>
												<img src="https://owner.com/wp-content/uploads/2021/07/slide-decor-b.svg" alt=""
													title="slide-decor-b" />
											</noscript>
										</div>
                ...
                <?php elseif ( get_row_layout() == 'video_slider' ) : ?>
                    <!-- video_slider -->
                    <section id="s-<?php echo $gg; ?>" class="py-15 pt-md-4 pb-md-5 pt-lg-10 video-slider">
                ...
                <?php elseif ( get_row_layout() == 'section_dont' ) : ?>
	                <!-- section_dont -->
	                <section id="ds-0" class="section-dont pt-10 pt-md-4 mb-9 bg-gr-b" data-aos="fade-up" data-aos-duration="2000">
						<div class="block-info">
							<div class="container">
								...
								<?php if( get_sub_field( 'item_list' ) ): ?>
									<ul class="dont-list mt-7">
										<?php while( has_sub_field( 'item_list' ) ): ?>
											<?php if( $text = get_sub_field( 'text' )): ?> 
												<li>
													<div class="item">
														<span class="item-p">
							...
							<div class="slogan-block text-center">
								<img class="pb-6" alt="" data-src="<?php echo get_template_directory_uri( ); ?>/images/landing/arrow-bottom03.svg"
									class="ls-is-cached lazyloaded" src="<?php echo get_template_directory_uri( ); ?>/images/landing/arrow-bottom03.svg">
								<?php if( $bottom_text = get_sub_field( 'bottom_text' )): ?> 
									<div class="s-slogan">
										<h3>
											<?php echo $bottom_text; ?>
										</h3>
										<h3>So we built the Restaurant Funnel.</h3>
									</div>
								<?php endif; ?>
                        ...
                        <div class="container container-md">
                            <div class="grid slogan">
                                ...
                                <?php if( $content = get_sub_field( 'content' )): ?> 
                                    <div class="col-6 col-md-12">
                                        <div class="txt-border txt-border-full pb-4 pb-md-1">
                                            <p>
                                                <?php echo $content; ?>
                                            </p>
                                        </div>
                ...
                <?php elseif ( get_row_layout() == 'image_content' ) : ?>
                    ...
                    <?php if( 's1' == $type ): ?> 
                        <?php 
                            ...
                            $img_class = get_sub_field( 'image_style' );     

                            $i_size = 'ci';
                            $i_size_2x = 'ci-2x';
                            if( 's1' == get_sub_field( 'image_size' ) ){
	                            $i_size = 'ci-13';
	                            $i_size_2x = 'ci-13-2x';
                            }
                            elseif( 's2' == get_sub_field( 'image_size' ) ){
                            	$i_size = 'ci-14';
	                            $i_size_2x = 'ci-14-2x';
                            }
                            elseif( 's3' == get_sub_field( 'image_size' ) ){
                            	$i_size = 'ci-15';
	                            $i_size_2x = 'ci-15-2x';
                            }
                            elseif( 's4' == get_sub_field( 'image_size' ) ){
                            	$i_size = 'ci-16';
	                            $i_size_2x = 'ci-16-2x';
                            }
                            elseif( 's5' == get_sub_field( 'image_size' ) ){
                            	$i_size = 'ci-17';
	                            $i_size_2x = 'ci-17-2x';
                            }
                            elseif( 's6' == get_sub_field( 'image_size' ) ){
                            	$i_size = 'ci-18';
	                            $i_size_2x = 'ci-18-2x';
                            }
                            elseif( 's7' == get_sub_field( 'image_size' ) ){
                            	$i_size = 'ci-19';
	                            $i_size_2x = 'ci-19-2x';
                            }
                        ?>
                        <!--  <?php echo $i_size;  ?> <?php echo $i_size_2x;  ?> align: <?php echo get_sub_field( 'image_align' ) ?>-->
                            ...
                            <div class="container">
                                <div class="col-img-txt <?php echo $s_class; ?>">
                                    <div class="col col-txt" data-aos="<?php echo $fade ?>" data-aos-duration="2000">
                                        ...
                                        <?php get_template_part_args( 'templates/landing-content-modules-testimonial-desktop' ); ?>
                                    </div>
                                    <?php if( 'right' == get_sub_field( 'image_align' ) ): ?>
                                        <?php $image = get_sub_field( 'image' ) ?>
                                        <?php if( !empty( $image ) ): ?>
                                            <?php $bg_url = $image['sizes'][$i_size]; ?>
                                            <?php $bg_ur_2x = $image['sizes'][$i_size_2x]; ?>
                                            <div class="col col-img">
                                                ...
                                                <?php get_template_part_args( 'templates/landing-content-modules-testimonial-mobile' ); ?>
                                            </div>
                                        <?php endif; ?>
                                    <?php endif; ?>
                    ...
                    <?php elseif( 's2' == $type ): ?>
                        ...
                        <?php elseif( 's3' == $animation_style ): ?>
                            <section id="s-<?php echo $gg; ?>" class="pt-15 pb-10 py-md-1 pt-md-5 bg-last">
                                <div class="container">
                ...
                <?php elseif ( get_row_layout() == 'pricing' ) : ?>
                    ...
                    <section id="s-<?php echo $gg; ?>" class="pt-4 pb-12 pb-md-6" data-aos="fade-up" data-aos-duration="2000">
						...
						<div class="get-pricing-block">
							<div class="container">
								<div class="box-form">
									<form action="#" class="pp-a-form">
										<div class="f-col">
											<div class="pp-a-form__i-wrap f-row">
												<input id="search_auto_0" class="i-i locationTextField pre-sf-search-input pac-target-input input-ico-location"
													type="text" placeholder="Enter Location" autocomplete="off">
											</div>
											<div class="pp-a-form__btn-wrap f-row">
												<button class="s-b btn btn-white" type="submit">Get Pricing Details</button>
											</div>
										</div>
									</form>
								</div>
                    ...
                    <section  id="s-<?php echo $gg; ?>" class="py-7 py-lg-6" data-aos="fade-up" data-aos-duration="2000">
                        <div class="container">
                            <div class="block-contact">
                                <div class="head text-center mb-9 mb-md-0">
                                	<?php get_template_part_args( 'templates/landing-content-modules-icon', array( '' => true ) ); ?>
                                    <?php if( $heading = get_sub_field( 'heading' )): ?> 
                                        <h2 class="h1">
                                            <?php echo $heading; ?>
                                    ...
                                    <?php endif; ?>
                                    <?php if( $subheading = get_sub_field( 'subheading' )): ?> 
                                        <div class="txt m-auto w-700 pb-7">
                                            <p>
                                                <?php echo $subheading; ?>
                                            </p>
                                        </div>
                ...
                <?php elseif ( get_row_layout() == 'investor' ) : ?>
                    <!-- investor -->
                    <section id="s-<?php echo $gg; ?>" class="pt-4 pb-16 pb-md-10">
                        <div class="container">
